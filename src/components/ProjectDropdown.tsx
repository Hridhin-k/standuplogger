...
function ProjectDropdown() {
  ...
  const onSelectProject = (e: React.MouseEvent<HTMLLIElement>) => {
    // setProjectName((e.target as HTMLElement).innerHTML);
    setProjectName((e.target as HTMLElement).innerText);

    console.log(projectName, "what is project name");
 ...
 rounded-full  text-base  px-4 py-1  text-center inline-flex items-center border  border-green-500
   truncate"
      ...
      >
        <div>
          <ul className="overflow-auto h-[165px] rounded-lg ">
